...
@Composable
fun ReportScreen(navController: NavController, reportViewModel: ReportViewModel, authViewModel: AuthViewModel) {
        ...
        Surface(
            ...
            when (reportViewModel.reportState) {
                ...
                is ReportResource.NotReported -> ReportScreenContent(navController, reportViewModel, authViewModel)
                is ReportResource.Reported -> SuccessPage(navController, "home", "Waste sight reported successfully")
            }
        }
}